  ...
  oe = (t, e, r) =>
    e.has(t)
      ...
      : e instanceof WeakSet
        ? e.add(t)
        : e.set(t, r),
  le = (t, e, r, a) => (Ga(t, e, 'write to private field'), a ? a.call(t, r) : e.set(t, r), r),
  me = (t, e, r) => (Ga(t, e, 'access private method'), r)
;(function () {
...
const De = 2,
  ...
  Il = Symbol(''),
  Pa = Symbol('attributes'),
  as = Symbol('class'),
  ss = Symbol('style'),
  ta = Symbol('text'),
  Ea = Symbol('form reset'),
...
function yn(t) {
  var e = ve
  if (e === null) return ((ce.f |= nr), t)
  if ((e.f & Vr) === 0 && (e.f & Hr) === 0) throw t
  tr(t, e)
}
function tr(t, e) {
  if (!(e !== null && (e.f & it) !== 0)) {
...
function xs(t) {
  ;(t.f & pt) !== 0 || t.deps === null ? Te(t, $e) : Te(t, St)
}
function wn(t) {
  if (t !== null)
    for (const e of t) (e.f & De) === 0 || (e.f & Sr) === 0 || ((e.f ^= Sr), wn(e.deps))
}
function bn(t, e, r) {
  ;((t.f & Re) !== 0 ? e.add(t) : (t.f & St) !== 0 && r.add(t), wn(t.deps), Te(t, $e))
}
let xa = !1
function fi(t) {
  var e = xa
      ...
      t => {
        Promise.resolve().then(() => {
          ...
          if (!t.defaultPrevented)
            for (const r of t.target.elements) (e = r[Ea]) == null || e.call(r)
        })
      },
      { capture: !0 }
    ))
...
class mi {
  ...
  update_pending_count(e, r) {
    ;(me(this, ze, ls).call(this, e, r),
      le(this, hr, x(this, hr) + e),
      !(!x(this, qt) || x(this, Rr)) &&
        (le(this, Rr, !0),
        lr(() => {
          ;(le(this, Rr, !1), x(this, qt) && Kr(x(this, qt), x(this, hr)))
        })))
  }
  get_effect_pending() {
    return (x(this, Fa).call(this), n(x(this, qt)))
  }
  error(e) {
    if (!x(this, ut).onerror && !x(this, ut).failed) throw e
    te != null && te.is_fork
      ? (x(this, ft) && te.skip_effect(x(this, ft)),
        x(this, Ve) && te.skip_effect(x(this, Ve)),
        x(this, nt) && te.skip_effect(x(this, nt)),
        te.oncommit(() => {
          me(this, ze, is).call(this, e)
        }))
      : me(this, ze, is).call(this, e)
  }
}
;((ct = new WeakMap()),
  ...
  (bi = function () {
    ...
    e &&
      ...
      lr(() => {
        var r = le(this, jt, document.createDocumentFragment()),
          a = Gt()
        ;(r.append(a),
          le(
            this,
            ft,
            me(this, ze, za).call(this, () => ht(() => x(this, fr).call(this, a)))
          ),
          x(this, Qt) === 0 &&
            (x(this, ct).before(r),
            le(this, jt, null),
  ...
  (ns = function () {
    try {
      if (
        ...
        var e = le(this, jt, document.createDocumentFragment())
        Cs(x(this, ft), e)
      ...
      } else me(this, ze, Ma).call(this, te)
    } catch (r) {
      this.error(r)
    }
  }),
  ...
  (za = function (e) {
    var r = ve,
      a = ce,
      s = Me
    ;($t(x(this, Ze)), gt(x(this, Ze)), Ur(x(this, Ze).ctx))
    try {
      return (Pr.ensure(), e())
    } catch (l) {
      return (yn(l), null)
  ...
  (ls = function (e, r) {
    ...
    if (!this.has_pending_snippet()) {
      this.parent && me((a = this.parent), ze, ls).call(a, e, r)
      return
    }
    ;(le(this, Qt, x(this, Qt) + e),
      x(this, Qt) === 0 &&
        (me(this, ze, Ma).call(this, r),
        x(this, Ve) &&
          yr(x(this, Ve), () => {
            le(this, Ve, null)
          }),
        x(this, jt) && (x(this, ct).before(x(this, jt)), le(this, jt, null))))
  }),
  (is = function (e) {
    ;(x(this, ft) && (tt(x(this, ft)), le(this, ft, null)),
      x(this, Ve) && (tt(x(this, Ve)), le(this, Ve, null)),
      x(this, nt) && (tt(x(this, nt)), le(this, nt, null)))
...
function $a(t = !0) {
  ;($t(null), gt(null), Ur(null), t && (te == null || te.deactivate()))
}
function kn() {
  var t = ve,
    e = t.b,
...
function Si(t, e, r) {
  ...
  return (
    Di(() => {
      ...
      var h = te
      if (i) {
        if ((o.f & Vr) !== 0) var _ = kn()
        if ((g = a.b) != null && g.is_rendered())
          (m = h.async_deriveds.get(o)) == null || m.reject(ra)
        else for (const y of v.values()) y.reject(ra)
        ;(v.add(d), h.async_deriveds.set(o, d))
      }
      const f = (y, w = void 0) => {
        ;(_ == null || _(),
          v.delete(d),
          w !== ra &&
            (h.activate(),
            w ? ((l.f |= nr), Kr(l, w)) : ((l.f & nr) !== 0 && (l.f ^= nr), Kr(l, y)),
            h.deactivate()))
      }
...
function Sn(t) {
  ...
  if (
    !t.equals(e) &&
    ((t.wv = Vn()),
    (!(te != null && te.is_fork) || t.deps === null) &&
      (te !== null ? (te.capture(t, e, !0), la == null || la.capture(t, e, !0)) : (t.v = e),
      t.deps === null))
  ) {
    Te(t, $e)
    return
  }
  Wt || (Be !== null ? (Ms() || (te != null && te.is_fork)) && Be.set(t, e) : xs(t))
}
function Ei(t) {
  var e
  if (t.effects !== null)
...
var Bs = 0
let Mi = 1
var Nr, er, pr, Fr, Dr, jr, Bt, qr, Qe, ha, Ht, yt, At, Br, _r, xe, vs, aa, ds, En, Mn, Ir, zi, sa
const Da = class Da {
  constructor() {
    oe(this, xe)
    We(this, 'id', Mi++)
    ...
    We(this, 'is_fork', !1)
    oe(this, _r, !1)
    ;(Cr === null ? (Ka = Cr = this) : (le(Cr, pr, this), le(this, er, Cr)), (Cr = this))
  }
  skip_effect(e) {
    ;(x(this, At).has(e) || x(this, At).set(e, { d: [], m: [] }), x(this, Br).delete(e))
  }
  ...
  capture(e, r, a = !1) {
    ;(e.v !== Le && !this.previous.has(e) && this.previous.set(e, e.v),
      (e.f & nr) === 0 && (this.current.set(e, [r, a]), Be == null || Be.set(e, r)),
      this.is_fork || (e.v = r))
  }
  activate() {
    te = this
  ...
  flush() {
    try {
      ;((Wa = !0), (te = this), me(this, xe, aa).call(this))
    } finally {
      ;((Bs = 0),
        (os = null),
        (Or = null),
  ...
  discard() {
    ...
    ;(me(this, xe, sa).call(this), (e = x(this, qr)) == null || e.resolve())
  }
  register_created_effect(e) {
    x(this, ha).push(e)
  }
  increment(e, r) {
    if ((le(this, jr, x(this, jr) + 1), e)) {
      let a = x(this, Bt).get(r) ?? 0
      x(this, Bt).set(r, a + 1)
    }
  }
  decrement(e, r) {
    if ((le(this, jr, x(this, jr) - 1), e)) {
      let a = x(this, Bt).get(r) ?? 0
      a === 1 ? x(this, Bt).delete(r) : x(this, Bt).set(r, a - 1)
    }
    x(this, _r) ||
      (le(this, _r, !0),
      lr(() => {
        ;(le(this, _r, !1), this.linked && this.flush())
      }))
  }
  transfer_effects(e, r) {
    for (const a of e) x(this, Ht).add(a)
  ...
  settled() {
    return (x(this, qr) ?? le(this, qr, cn())).promise
  }
  static ensure() {
    if (te === null) {
      const e = (te = new Da())
  ...
  schedule(e) {
    ...
    if (
      ((os = e),
      (s = e.b) != null && s.is_pending && (e.f & (Hr | ga | un)) !== 0 && (e.f & Vr) === 0)
    ) {
      e.b.defer_effect(e)
      return
    }
    for (var r = e; r.parent !== null;) {
      r = r.parent
      var a = r.f
      if (Or !== null && r === ve && (ce === null || (ce.f & De) === 0)) return
      if ((a & (Kt | _t)) !== 0) {
        if ((a & $e) === 0) return
        r.f ^= $e
      }
...
;((Nr = new WeakMap()),
  ...
  (aa = function () {
    var o, d, h, _
    ;(le(this, Nr, !0), Bs++ > 1e3 && (me(this, xe, sa).call(this), Ti()))
    for (const f of x(this, Ht)) (x(this, yt).delete(f), Te(f, Re), this.schedule(f))
    for (const f of x(this, yt)) (Te(f, St), this.schedule(f))
    const e = x(this, Qe)
    ;(le(this, Qe, []), this.apply())
    var r = (Or = []),
      a = [],
      s = (Aa = [])
    for (const f of e)
      try {
        me(this, xe, ds).call(this, f, r, a)
      } catch (g) {
        throw (Tn(f), me(this, xe, vs).call(this) || this.discard(), g)
      }
    if (((te = null), s.length > 0)) {
      var l = Da.ensure()
      for (const f of s) l.schedule(f)
    }
    if (((Or = null), (Aa = null), me(this, xe, vs).call(this))) {
      ;(me(this, xe, Ir).call(this, a), me(this, xe, Ir).call(this, r))
      for (const [f, g] of x(this, At)) An(f, g)
      s.length > 0 && me((o = te), xe, aa).call(o)
      return
    }
    const i = me(this, xe, En).call(this)
    if (i) {
      ;(me(this, xe, Ir).call(this, a),
        me(this, xe, Ir).call(this, r),
        me((d = i), xe, Mn).call(d, this))
      return
    }
    ;(x(this, Ht).clear(), x(this, yt).clear())
    ...
    ;(x(this, Fr).clear(),
      ...
      Hs(r),
      (la = null),
      (h = x(this, qr)) == null || h.resolve())
    var v = te
    if (
      (x(this, jr) === 0 && (x(this, Qe).length === 0 || v !== null) && me(this, xe, sa).call(this),
      x(this, Qe).length > 0)
    )
      if (v !== null) {
        const f = v
        x(f, Qe).push(...x(this, Qe).filter(g => !x(f, Qe).includes(g)))
      } else v = this
    v !== null && me((_ = v), xe, aa).call(_)
  }),
  (ds = function (e, r, a) {
    e.f ^= $e
  ...
  (Mn = function (e) {
    ...
    ;(e.async_deriveds.clear(), this.transfer_effects(x(e, Ht), x(e, yt)))
    const r = s => {
      var l = s.reactions
      if (l !== null && !((s.f & De) !== 0 && (s.f & (Re | St)) === 0))
        for (const o of l) {
          var i = o.f
          if ((i & De) !== 0) r(o)
          else {
    ...
    ;(this.oncommit(() => e.discard()),
      me((a = e), xe, sa).call(a),
      (te = this),
      me(this, xe, aa).call(this))
  }),
  (Ir = function (e) {
    for (var r = 0; r < e.length; r += 1) bn(e[r], x(this, Ht), x(this, yt))
  }),
  (zi = function () {
    var _
    for (let f = Ka; f !== null; f = x(f, pr)) {
      ...
      if (!(!x(f, Nr) || s.length === 0)) {
        var l = s.filter(g => !this.current.has(g))
        if (l.length === 0) e && f.discard()
        else if (r.length > 0) {
          if (e)
            for (const g of x(this, Br))
              f.unskip_effect(g, m => {
                var y
                ;(m.f & (xt | $r)) !== 0 ? f.schedule(m) : me((y = f), xe, Ir).call(y, [m])
              })
          f.activate()
          var i = new Set(),
            v = new Map()
          ...
          var d = [...f.current]
            ...
            .map(([g]) => g)
          if (d.length > 0)
            for (const g of x(this, ha))
              (g.f & (it | Je | Oa)) === 0 &&
                Ps(g, d, v) &&
                ((g.f & ($r | xt)) !== 0 ? (Te(g, Re), f.schedule(g)) : x(f, Ht).add(g))
          if (x(f, Qe).length > 0 && !x(f, _r)) {
            f.apply()
            for (var h of x(f, Qe)) me((_ = f), xe, ds).call(_, h, [], [])
            le(f, Qe, [])
          }
          f.deactivate()
        }
  ...
  (sa = function () {
    if (this.linked) {
      var e = x(this, er),
        r = x(this, pr)
      ;(e === null ? (Ka = r) : le(e, pr, r),
        r === null ? (Cr = e) : le(r, er, e),
        (this.linked = !1))
    }
  }))
let Pr = Da
...
function zn(t, e, r, a) {
  if (!r.has(t) && (r.add(t), t.reactions !== null))
    for (const s of t.reactions) {
      ...
      ;(l & De) !== 0
        ? zn(s, e, r, a)
        : (l & ($r | xt)) !== 0 && (l & Re) === 0 && Ps(s, e, a) && (Te(s, Re), Es(s))
    }
}
function Ps(t, e, r) {
  const a = r.get(t)
  ...
  if (t.deps !== null)
    for (const s of t.deps) {
      if (Ia.call(e, s)) return !0
      if ((s.f & De) !== 0 && Ps(s, e, r)) return (r.set(s, !0), !0)
    }
  return (r.set(t, !1), !1)
}
function Es(t) {
...
function An(t, e) {
  if (!((t.f & _t) !== 0 && (t.f & $e) !== 0)) {
    ;((t.f & Re) !== 0 ? e.d.push(t) : (t.f & St) !== 0 && e.m.push(t), Te(t, $e))
...
function Kr(t, e, r = null) {
  if (!t.equals(e)) {
    mr.set(t, Wt ? e : t.v)
    var a = Pr.ensure()
    if ((a.capture(t, e), (t.f & De) !== 0)) {
      const s = t
      ;((t.f & Re) !== 0 && Ss(s), Be === null && xs(s))
    }
    ;((t.wv = Vn()),
      In(t, Re, r),
      ya() &&
...
function In(t, e, r) {
  ...
  if (a !== null)
    for (var s = ya(), l = a.length, i = 0; i < l; i++) {
      ...
      if (!(!s && v === ve)) {
        var d = (o & Re) === 0
        if ((d && Te(v, e), (o & Oa) !== 0)) Ra.add(v)
        else if ((o & De) !== 0) {
          var h = v
          ;(Be == null || Be.delete(h),
            (o & Sr) === 0 &&
              (o & pt && (ve === null || (ve.f & La) === 0) && (v.f |= Sr), In(h, St, r)))
        } else if (d) {
          var _ = v
          ;((o & xt) !== 0 && mt !== null && mt.add(_), r !== null ? r.push(_) : Es(_))
        }
      }
    }
}
  ...
  return (
    ...
    new Proxy(t, {
      ...
      has(v, o) {
        ...
        if (o === Ut) return !0
        var d = r.get(o),
          h = (d !== void 0 && d.v !== Le) || Reflect.has(v, o)
        if (d !== void 0 || (ve !== null && (!h || ((f = Lr(v, o)) != null && f.writable)))) {
          d === void 0 &&
            ((d = i(() => {
              var g = h ? Ne(v[o]) : Le,
                m = ee(g)
      ...
      set(v, o, d, h) {
        ...
        if (a && o === 'length')
          for (var g = d; g < _.v; g += 1) {
            var m = r.get(g + '')
            m !== void 0 ? C(m, Le) : g in v && ((m = i(() => ee(Le))), r.set(g + '', m))
          }
        if (_ === void 0)
          (!f || ((E = Lr(v, o)) != null && E.writable)) &&
            ((_ = i(() => ee(void 0))), C(_, Ne(d)), r.set(o, _))
        else {
          f = _.v !== Le
          var y = i(() => Ne(d))
          C(_, y)
      ...
      ownKeys(v) {
        n(s)
        var o = Reflect.ownKeys(v).filter(_ => {
          var f = r.get(_)
          return f === void 0 || f.v !== Le
        })
        for (var [d, h] of r) h.v !== Le && !(d in v) && o.push(d)
        return o
      },
      setPrototypeOf() {
        Hl()
...
function Li() {
  if (cs === void 0) {
    ...
    var t = Element.prototype,
      e = Node.prototype,
      r = Text.prototype
    ;((Ln = Lr(e, 'firstChild').get),
      ($n = Lr(e, 'nextSibling').get),
      js(t) && ((t[as] = void 0), (t[Pa] = null), (t[ss] = void 0), (t.__e = void 0)),
      js(r) && (r[ta] = void 0))
  }
}
function Gt(t = '') {
...
function Rt(t, e) {
  ...
  te == null || te.register_created_effect(a)
  var s = a
  if ((t & Hr) !== 0) Or !== null ? Or.push(a) : Pr.ensure().schedule(a)
  else if (e !== null) {
    try {
      Wr(a)
    } catch (i) {
  ...
  if (
    s !== null &&
    ((s.parent = r), r !== null && Ri(s, r), ce !== null && (ce.f & De) !== 0 && (t & Kt) === 0)
  ) {
    var l = ce
...
function zs(t) {
  const e = Rt(ga, null)
  return (Te(e, $e), (e.teardown = t), e)
}
function Lt(t) {
  Fn()
  var e = ve.f,
    r = !ce && (e & _t) !== 0 && Me !== null && !Me.i
  if (r) {
    var a = Me
    ;(a.e ?? (a.e = [])).push(t)
  } else return Dn(t)
...
function tt(t, e = !0) {
  ...
  ;((e || (t.f & Tl) !== 0) &&
    t.nodes !== null &&
    t.nodes.end !== null &&
    (Bn(t.nodes.start, t.nodes.end), (r = !0)),
    (t.f |= rs),
    Ts(t, e && !r),
    ca(t, 0))
...
function Gn(t, e) {
  if ((t.f & Je) !== 0) {
    ;((t.f ^= Je), (t.f & $e) === 0 && (Te(t, Re), Pr.ensure().schedule(t)))
...
function Yn(t, e, r = !0) {
  ...
  if (a !== null && !(Ot !== null && Ot.has(t)))
    for (var s = 0; s < a.length; s++) {
      ...
      ;(l.f & De) !== 0
        ? Yn(l, e, !1)
        : e === l && (r ? Te(l, Re) : (l.f & $e) !== 0 && Te(l, St), Es(l))
    }
}
function Jn(t) {
  var y
  ...
  try {
    ...
    t.f |= Vr
    var f = t.deps,
      g = te == null ? void 0 : te.is_fork
    if (et !== null) {
      var m
      if ((g || ca(t, st), f !== null && st > 0))
        for (f.length = st + et.length, m = 0; m < et.length; m++) f[st + m] = et[m]
      else t.deps = f = et
      if (Ms() && (t.f & pt) !== 0)
        for (m = st; m < f.length; m++) ((y = f[m]).reactions ?? (y.reactions = [])).push(t)
    } else !g && f !== null && st < f.length && (ca(t, st), (f.length = st))
    if (ya() && dt !== null && !kt && f !== null && (t.f & (De | St | Re)) === 0)
      for (m = 0; m < dt.length; m++) Yn(dt[m], t)
    if (s !== null && s !== t) {
      if ((cr++, s.deps !== null)) for (let w = 0; w < r; w += 1) s.deps[w].rv = cr
      if (e !== null) for (const w of e) w.rv = cr
      dt !== null && (a === null ? (a = dt) : a.push(...dt))
    }
    return ((t.f & nr) !== 0 && (t.f ^= nr), _)
  } catch (w) {
    return yn(w)
  } finally {
    ;((t.f ^= La), (et = e), (st = r), (dt = a), (ce = s), (Ot = l), Ur(i), (kt = v), (wr = o))
  }
}
function Bi(t, e) {
  let r = e.reactions
  ...
  if (r === null && (e.f & De) !== 0 && (et === null || !Ia.call(et, e))) {
    var l = e
...
function ca(t, e) {
  var r = t.deps
  if (r !== null) for (var a = e; a < r.length; a++) Bi(t, r[a])
}
function Wr(t) {
  var e = t.f
  if ((e & it) === 0) {
...
function n(t) {
  ...
  if (ce !== null && !kt) {
    ...
    if (!a && (Ot === null || !Ot.has(t))) {
      ...
      if ((ce.f & La) !== 0)
        ...
        ;(ce.deps ?? (ce.deps = []), Ia.call(ce.deps, t) || ce.deps.push(t))
        var l = t.reactions
        l === null ? (t.reactions = [ce]) : Ia.call(l, ce) || l.push(ce)
      }
    }
  }
  ...
  if (r) {
    ...
    if (Wt) {
      var v = i.v
      return ((((i.f & $e) === 0 && i.reactions !== null) || Zn(i)) && (v = Ss(i)), mr.set(i, v), v)
    }
    var o = (i.f & pt) === 0 && !kt && ce !== null && (Ta || (ce.f & pt) !== 0),
      d = (i.f & Vr) === 0
    ;(ba(i) && (o && (i.f |= pt), Sn(i)), o && !d && (Pn(i), Xn(i)))
  }
  if (Be != null && Be.has(t)) return Be.get(t)
  ...
  if (((t.f |= pt), t.deps !== null))
    for (const e of t.deps)
      ((e.reactions ?? (e.reactions = [])).push(t),
        (e.f & De) !== 0 && (e.f & pt) === 0 && (Pn(e), Xn(e)))
}
function Zn(t) {
  if (t.v === Le) return !0
  if (t.deps === null) return !1
  for (const e of t.deps) if (mr.has(e) || ((e.f & De) !== 0 && Zn(e))) return !0
  return !1
}
function Zr(t) {
  var e = kt
...
function hs(t) {
  ...
  var e = this,
    r = e.ownerDocument,
    a = t.type,
    s = ((y = t.composedPath) == null ? void 0 : y.call(t)) || [],
    l = s[0] || t.target
  Ws = t
  var i = 0,
    v = Ws === t && t[ur]
  ...
  if (((l = s[i] || t.target), l !== e)) {
    ...
    ;(gt(null), $t(null))
    try {
      for (var f, g = []; l !== null && l !== e;) {
        try {
          var m = (w = l[ur]) == null ? void 0 : w[a]
          m != null && (!l.disabled || t.target === l) && m.call(l, t)
        } catch ($) {
          f ? g.push($) : (f = $)
        }
      ...
      ;((t[ur] = e), delete t.currentTarget, gt(h), $t(_))
    }
  }
}
var nn
    ...
    d = Fi(() => {
      ...
      gi(
        ...
        g => {
          he({})
          var m = Me
          ;(l && (m.c = l), s && (a.$$events = s), (o = t(g, a) || {}), pe())
        },
        v
      )
      var _ = new Set(),
          ...
          for (var m = 0; m < g.length; m++) {
            ...
            if (!_.has(y)) {
              ...
              for (const E of [e, document]) {
                var $ = ka.get(E)
                $ === void 0 && (($ = new Map()), ka.set(E, $))
                var N = $.get(y)
                N === void 0
                  ? (E.addEventListener(y, hs, { passive: w }), $.set(y, 1))
                  : $.set(y, N + 1)
              }
            }
          }
          ...
          for (var g of _)
            for (const $ of [e, document]) {
              var m = ka.get($),
                y = m.get(g)
              --y == 0
                ? ($.removeEventListener(g, hs), m.delete(g), m.size === 0 && ka.delete($))
                : m.set(g, y)
            }
          ;(fs.delete(f), h !== r && ((w = h.parentNode) == null || w.removeChild(h)))
        }
      )
    })
  return (Zi.set(o, d), o)
...
class tl {
  constructor(e, r = !0) {
    ...
    if ((x(this, wt).set(a, e), s)) {
      ...
      ;(a.oncommit(x(this, _a)), a.ondiscard(x(this, ja)))
      ...
      () => {
        if (l) {
          if ((l.pending.delete(_), l.done.add(_), l.pending.size === 0)) {
            var f = t.outrogroups
            ;(ps(t, qa(l.done)), f.delete(l), f.size === 0 && (t.outrogroups = null))
          }
        } else i -= 1
      },
      !1
...
function Se(t, e, r, a, s, l = null) {
  ...
  var $ = Ba(() => {
      f = n(_)
      for (var E = f.length, R = new Set(), D = te, V = Rn(), M = 0; M < E; M += 1) {
        var U = f[M],
          K = a(U, M),
          I = m ? null : v.get(K)
        ;(I
          ? (I.v && Kr(I.v, U), I.i && Kr(I.i, M), V && D.unskip_effect(I.e))
          : ((I = to(v, m ? i : (Vs ?? (Vs = Gt())), U, K, M, s, e, r)),
            m || (I.e.f |= Ct),
            v.set(K, I)),
          R.add(K))
      }
      if (
        (E === 0 &&
          l &&
          !h &&
          (m ? (h = ht(() => l(i))) : ((h = ht(() => l(Vs ?? (Vs = Gt())))), (h.f |= Ct))),
        E > R.size && Rl(),
        !m)
      )
        if ((g.set(D, R), V)) {
          for (const [P, z] of v) R.has(P) || D.skip_effect(z.e)
          ;(D.oncommit(y), D.ondiscard(w))
        } else y(D)
      n(_)
    }),
    N = { effect: $, items: v, pending: g, outrogroups: null, fallback: h }
  m = !1
}
function Qr(t) {
...
function eo(t, e, r, a, s) {
    ...
    for ($ = 0; $ < i; $ += 1)
      ((m = e[$]),
        ...
        (w.f & Ct) === 0 &&
          ...
          (_ ?? (_ = new Set())).add(w)))
  for ($ = 0; $ < i; $ += 1) {
    if (((m = e[$]), (y = s(m, $)), (w = v.get(y).e), t.outrogroups !== null))
      for (const O of t.outrogroups) (O.pending.delete(w), O.done.delete(w))
    if (
      ((w.f & Je) !== 0 &&
        (Na(w),
        l &&
    ...
    if (w !== o) {
      if (d !== void 0 && d.has(w)) {
        if (f.length < g.length) {
          ...
          for (R = 0; R < g.length; R += 1) d.delete(g[R])
          ;(Jt(t, D.prev, V.next),
            Jt(t, h, D),
            Jt(t, V, E),
            (o = E),
          ...
          (d.delete(w),
            na(w, o, r),
            Jt(t, w.prev, w.next),
            Jt(t, w, h === null ? t.effect.first : h.next),
            Jt(t, h, w),
            (h = w))
        continue
      }
      for (f = [], g = []; o !== null && o !== w;)
        ((d ?? (d = new Set())).add(o), g.push(o), (o = Qr(o.next)))
      if (o === null) continue
    }
    ;((w.f & Ct) === 0 && f.push(w), (h = w), (o = Qr(w.next)))
  }
  if (t.outrogroups !== null) {
    for (const O of t.outrogroups)
      O.pending.size === 0 && (ps(t, qa(O.done)), (q = t.outrogroups) == null || q.delete(O))
  ...
  if (o !== null || d !== void 0) {
    ...
    if (U > 0) {
      ...
      if (l) {
        for ($ = 0; $ < U; $ += 1)
          (T = (S = M[$].nodes) == null ? void 0 : S.a) == null || T.measure()
        for ($ = 0; $ < U; $ += 1) (j = (B = M[$].nodes) == null ? void 0 : B.a) == null || j.fix()
      }
      Qi(t, M, K)
    }
  }
  l &&
    lr(() => {
      var O, F
      if (_ !== void 0) for (w of _) (F = (O = w.nodes) == null ? void 0 : O.a) == null || F.apply()
    })
}
...
function ro(t, e, r = !1, a = !1, s = !1, l = !1) {
  ...
  L(() => {
    ...
    if (v !== (v = e() ?? '')) {
      ...
      if ((d.nodes !== null && (Bn(d.nodes.start, d.nodes.end), (d.nodes = null)), v !== '')) {
        var h = a ? ai : s ? si : void 0,
          _ = Nn(a ? 'svg' : s ? 'math' : 'template', h)
        _.innerHTML = v
...
function no(t, e, r = e) {
  ...
  ;(xn(t, 'change', l => {
    ...
    ;(r(v), (t.__value = v), te !== null && a.add(te))
  }),
    jn(() => {
      var l = e()
...
function rl(t) {
  return t[Pa] ?? (t[Pa] = { [lo]: t.nodeName.includes('-'), [io]: t.namespaceURI === pn })
}
var Js = new Map()
function vo(t) {
...
function Ha(t, e, r = e) {
  ...
  ;(xn(t, 'input', async s => {
    ...
    if (((l = Ya(t) ? Ja(l) : l), r(l), te !== null && a.add(te), await Hi(), l !== (l = e()))) {
    ...
    Zr(e) == null && t.value && (r(Ya(t) ? Ja(t.value) : t.value), te !== null && a.add(te)),
    As(() => {
      var s = e()
      if (t === document.activeElement) {
        var l = te
...
function ue(t, e, r, a) {
  ...
  var s = !Jr || (r & Xl) !== 0,
    ...
    o = !0,
    d = void 0,
    h = () => (i && s ? (d ?? (d = Gr(a)), n(d)) : (o && ((o = !1), (v = i ? Zr(a) : a)), v))
  let _
  if (l) {
    var f = Ut in t || Cl in t
    _ = ((R = Lr(t, e)) == null ? void 0 : R.set) ?? (f && e in t ? D => (t[e] = D) : void 0)
  }
  var g,
    m = !1
  ;(l ? ([g, m] = fi(() => t[e])) : (g = t[e]),
    g === void 0 && a !== void 0 && ((g = h()), _ && (s && ql(), _(g))))
  var y
  if (
    (s
      ? (y = () => {
          var D = t[e]
          return D === void 0 ? h() : ((o = !0), D)
        })
      : (y = () => {
          var D = t[e]
  ...
  if (_) {
    var w = t.$$legacy
    return function (D, V) {
      return arguments.length > 0 ? ((!s || !V || w || m) && _(V ? y() : D), D) : y()
    }
  }
  var $ = !1,
    N = ((r & Jl) !== 0 ? Gr : ks)(() => (($ = !1), y()))
  ...
  return function (D, V) {
    if (arguments.length > 0) {
      const M = V ? n(N) : s && l ? Ne(D) : D
      return (C(N, M), ($ = !0), v !== void 0 && (v = M), D)
    }
    return (Wt && $) || (E.f & it) !== 0 ? N.v : n(N)
  }
}
function sl(t) {
  ;(Me === null && Ll(),
...
const Pt = Ne({ toasts: [], commandOpen: !1, loadingRoutes: new Set() })
let po = 0
function ge(t, e = 'info', r = 4e3) {
  const a = ++po,
...
const Ee = Ne({ list: [], loading: !1, error: null })
async function Rs(t) {
...
async function fl(t) {
  try {
    const e = await Eo(t)
    if (!e.ok) {
      ge(e.error ? String(e.error) : 'Refresh failed', 'error')
      return
    }
    ;(await Rs(), ge(`Refreshed ${t} (${e.count ?? 0} models)`, 'success'))
  } catch (e) {
    ge(e instanceof Error ? e.message : String(e), 'error')
  }
}
async function Sa() {
  try {
    const t = await Mo()
    ;(await Rs(), ge(`Refreshed all · ${t.total} models`, 'success'))
  } catch (t) {
    ge(t instanceof Error ? t.message : String(t), 'error')
  }
}
const ev = 20,
  tv = 6,
  fe = Ne({ general: [], agy: [], loading: !1, error: null })
async function hl() {
  fe.loading = !0
  try {
    const t = await $s()
    ;((fe.general = t.favoriteModels ?? []), (fe.agy = t.antigravityCliFavoriteModels ?? []))
  } catch (t) {
    fe.error = t instanceof Error ? t.message : String(t)
  } finally {
    fe.loading = !1
  }
}
async function Ns() {
  await dl({ favoriteModels: fe.general, antigravityCliFavoriteModels: fe.agy })
}
function pl(t, e, r = !1) {
  return (r ? fe.agy : fe.general).some(s => s.providerId === t && s.modelId === e)
}
async function _l(t, e = !1) {
  const r = e ? fe.agy : fe.general,
    a = e ? tv : ev
  return pl(t.providerId, t.modelId, e)
    ? !0
    : r.length >= a
      ? (ge(`Favorite limit reached (${a})`, 'error'), !1)
      : (e ? (fe.agy = [...fe.agy, t]) : (fe.general = [...fe.general, t]), await Ns(), !0)
}
async function gs(t, e, r = !1) {
  ;(r
    ? (fe.agy = fe.agy.filter(a => !(a.providerId === t && a.modelId === e)))
    : (fe.general = fe.general.filter(a => !(a.providerId === t && a.modelId === e))),
    await Ns())
}
async function rv(t, e = !1) {
  ;(e ? (fe.agy = t) : (fe.general = t), await Ns())
}
const av = Object.freeze(
  ...
  Ge = Ne({ list: [], recentFolders: [], loading: !1, error: null })
async function sv() {
  Ge.loading = !0
  try {
    const t = await Lo()
...
async function nv(t, e) {
  const r = await $o(t, e)
  r.ok && ((Ge.list = r.apps), ge(e ? 'Path saved' : 'Path cleared', 'success'))
}
async function Qa(t) {
  try {
    const e = await Ro(t)
    ;(t.cwd && (Ge.recentFolders = bo(t.cwd)), ge(`Launched ${t.appId}`, 'success'))
  } catch (e) {
    ge(e instanceof Error ? e.message : String(e), 'error')
  }
}
...
async function ov(t) {
  const e = t.id ?? `preset-${Date.now()}`,
    ...
    a = [...Et.list],
    s = { ...t, id: e }
  ;(r >= 0 ? (a[r] = s) : a.push(s), (Et.list = a), await cl(a), ge('Preset saved', 'success'))
}
async function vv(t) {
  ...
  ;(Se(
    ...
    (d, h) => {
      ...
      var g = c(_),
        ...
        w = c(y)
      ;(L(() => {
        ;((f = Ie(_, 1, 'nav-item svelte-6dohdz', null, f, { active: bt.route === n(h).id })),
          we(_, 'aria-current', bt.route === n(h).id ? 'page' : void 0),
          we(m, 'd', n(h).icon),
          A(w, n(h).label))
      }),
        ne('click', _, () => vr(n(h).id)),
        p(d, _))
    }
  ),
    L(() => A(v, `v${a}`)),
...
var hv = k('<span><!></span>')
function Ce(t, e) {
  let r = ue(e, 'tone', 3, 'neutral')
  var a = hv(),
    s = c(a)
  ;(Ar(s, () => e.children), L(() => Ie(a, 1, `badge ${r() ?? ''}`, 'svelte-7j44kq')), p(t, a))
}
var pv = k('<button><!></button>')
function _e(t, e) {
  let r = ue(e, 'variant', 3, 'primary'),
    a = ue(e, 'size', 3, 'md'),
    s = ue(e, 'disabled', 3, !1),
    l = ue(e, 'type', 3, 'button')
  var i = pv(),
    v = c(i)
  ;(Ar(v, () => e.children),
    L(() => {
  ...
  ;(Ar(v, () => e.children),
    L(() => {
      ;((i = Ie(l, 1, `card glass ${s() ?? ''}`, 'svelte-it2i29', i, { hover: a() })),
        ot(l, `padding:${r() ?? ''}`),
        we(l, 'role', e.onclick ? 'button' : void 0))
    }),
    ne('click', l, function (...o) {
      var d
      ;(d = e.onclick) == null || d.apply(this, o)
    }),
    p(t, l))
    ...
    var i = v => {
      ...
      ;(Ar(g, () => e.children),
        ...
        ne('click', o, function (...m) {
          var y
          ;(y = e.onclose) == null || y.apply(this, m)
        }),
...
function zr(t, e) {
  let r = ue(e, 'title', 3, 'Nothing here yet'),
    a = ue(e, 'icon', 3, 'M4 4h16v16H4z')
  var s = bv(),
    l = c(s),
    i = c(l),
    v = u(l, 2),
...
function wl(t, e) {
  ...
  ;(Ar(o, () => e.children ?? dn),
    L(() => {
      ;((l.disabled = a()), we(l, 'title', s()), we(l, 'aria-label', s() || r()))
    }),
    ne('click', l, function (...d) {
      var h
      ;(h = e.onclick) == null || h.apply(this, d)
    }),
    p(t, l))
}
Oe(['click'])
...
function Zt(t, e) {
  he(e, !0)
  let r = ue(e, 'value', 15, ''),
    a = ue(e, 'placeholder', 3, ''),
    s = ue(e, 'type', 3, 'text'),
    l = ue(e, 'id', 3, '')
  var i = Sv()
  ;(L(() => {
    ;(we(i, 'id', l()), we(i, 'type', s()), we(i, 'placeholder', a()), Os(i, r()))
  }),
    ne('input', i, v => {
      var o
      ;(r(v.currentTarget.value), (o = e.oninput) == null || o.call(e, r()))
    }),
    ne('keydown', i, function (...v) {
      var o
    ...
    s = Q(a)
  {
    var l = i => {
      ...
      ;(ne('click', v, function (...m) {
        ...
        ne('click', o, m => m.stopPropagation()),
        ne('keydown', o, m => m.stopPropagation()),
  ...
  Se(
    ...
    (o, d) => {
      var h = Mv(),
        ...
        f = {}
      ;(L(() => {
        ;(A(_, n(d).label), f !== (f = n(d).value) && (h.value = (h.__value = n(d).value) ?? ''))
      }),
        p(o, h))
    }
  )
...
function ir(t, e) {
    ...
    i = Q(l)
  {
    var v = d => {
        var h = Av()
        ;(L(() => ot(h, `width:${r() ?? ''}px;height:${r() ?? ''}px`)), p(d, h))
      },
      o = d => {
        var h = Cv(),
          _ = c(h),
        ...
        ;(L(() => {
          ;(we(h, 'aria-label', a() || 'Loading'),
            ot(_, `width:${r() ?? ''}px;height:${r() ?? ''}px`))
        }),
          p(d, h))
      }
    H(i, d => {
...
function Dv(t, e) {
  ...
  var s = Fv(),
    ...
    h = u(d, 2)
  {
    let _ = Y(() => (ar.value === 'dark' ? 'Switch to light' : 'Switch to dark'))
    wl(h, {
      get title() {
        return n(_)
      },
  ...
  ;(Se(
    ...
    (s, l) => {
      ...
      ;(L(() => {
        ...
        ne('click', i, () => _s(n(l).id)),
        ne('keydown', i, d => r(d, n(l).id)),
        p(s, i))
    }
  ),
    p(t, a),
...
Oe(['click', 'keydown'])
const Ye = Ne({ status: null, loading: !1, starting: !1, error: null })
let da = null
async function ms() {
  try {
...
async function Gv(t) {
  ...
  try {
    ...
    return e.ok && e.status
      ? ((Ye.status = e.status), ge('Server gateway started', 'success'), !0)
      : (ge(e.error ?? 'Failed to start server', 'error'), !1)
  } catch (e) {
    return (ge(e instanceof Error ? e.message : String(e), 'error'), !1)
  } finally {
    Ye.starting = !1
  }
}
async function Kv() {
  try {
    ;(await jo(), await ms(), ge('Server gateway stopped', 'info'))
  } catch (t) {
    ge(t instanceof Error ? t.message : String(t), 'error')
  }
}
...
function Jv(t, e) {
  ...
  ;(ne('click', o, function (...y) {
    var w
    ;(w = e.onclose) == null || w.apply(this, y)
  }),
...
const be = Ne({ report: null, range: 'all', loading: !1, error: null, hasData: !1 })
async function en(t = be.range) {
  ;((be.range = t), (be.loading = !0), (be.error = null))
  try {
    const e = await Xv(t)
    ;((be.report = e), (be.hasData = e.totalTokens > 0 || e.messages > 0))
  } catch (e) {
    ;((be.report = null),
      (be.hasData = !1),
      (be.error =
...
const qe = Ne({ report: null, available: !1, loading: !1, error: null })
async function tn() {
  var t, e
  qe.loading = !0
  try {
...
function rd(t, e) {
    ...
    l = u(c(s), 2)
  {
    ...
    H(l, y => {
      qe.loading ? y(i) : qe.available ? y(v, 1) : y(o, -1)
    })
  }
  var d = u(s, 2)
  {
  ...
  var _ = u(d, 2)
  {
    var f = y => {
      ...
      ;(L(
        b => {
          var q
          ;(A(R, (q = qe.report.keychain) != null && q.available ? 'Available' : 'Unavailable'),
    ...
    (l, i) => {
      ...
      ;(L(() => {
        ;((o = Ie(v, 1, 'opt svelte-1yfbpb7', null, o, { active: r() === n(i).id })),
          we(v, 'aria-pressed', r() === n(i).id),
          A(d, n(i).label))
      }),
        ne('click', v, () => {
          var h
          ;(r(n(i).id), (h = e.onchange) == null || h.call(e, n(i).id))
        }),
        p(l, v))
    }
  ),
...
function od(t, e) {
  ...
  ;(L(() => {
    ;(A(s, e.label), we(l, 'title', e.value), A(i, e.value))
  }),
    p(t, r))
}
...
function gd(t, e) {
  ...
  const r = Y(() => {
    ...
    a = Y(() => {
      ...
      return (
        e.days.forEach((g, m) => {
          const y = m + (n(r).length ? new Date(e.days[0].date + 'T00:00:00').getDay() : 0),
            w = Math.floor(y / 7),
            $ = new Date(g.date + 'T00:00:00').getMonth()
          $ !== f &&
            (_.push({
              col: w,
  ...
  Se(
    ...
    br,
    (_, f, g) => {
      const m = Y(() => n(a).find(N => N.col === g))
      var y = cd()
      let w
      var $ = c(y)
      ;(L(() => {
        ;((w = Ie(y, 1, 'month svelte-1ryzkww', null, w, { has: !!n(m) })),
          A($, n(m) ? n(m).label : ''))
      }),
        p(_, y))
    }
        ...
        (m, y) => {
            ...
            $ = Q(w)
          {
            var N = R => {
                ...
                ;(L(
                  (V, M) => {
                    ;(ot(D, `background:${V ?? ''}`), we(D, 'title', M))
                  },
  ...
  ;(Se(
    ...
    (_, f) => {
      var g = pd()
      ;(L(m => ot(g, `background:${m ?? ''}`), [() => l(f)]), p(_, g))
    }
  ),
    p(t, i),
    pe())
...
function kd(t, e) {
  he(e, !0)
  const r = Y(() => Math.max(1, ...e.data.map(E => E.tokens)))
  function a(E) {
    if (E <= 0) return 1
    const R = Math.floor(Math.log10(E)),
      ...
      V = E / D
    let M
    return (V <= 1 ? (M = 1) : V <= 2 ? (M = 2) : V <= 5 ? (M = 5) : (M = 10), M * D)
  }
  const s = Y(() => a(n(r))),
    l = Y(() => Array.from({ length: 5 }, (E, R) => n(s) * (1 - R / 4)))
  function i(E) {
    return E >= 1e9
      ? `${(E / 1e9).toFixed(1)}B`
      : E >= 1e6
  ...
  function o(E) {
    ...
    const R = new Date(e.data[E - 1].date + 'T00:00:00').getMonth(),
      D = new Date(e.data[E].date + 'T00:00:00').getMonth()
    return R !== D
  }
  let d = ee(null)
  const h = Y(() => (n(d) ? n(d).scrollWidth - n(d).clientWidth > 8 : !1))
  Lt(() => {
    e.data
    const E = n(d)
  ...
  Se(
    ...
    (E, R, D) => {
      ...
      ;(L(
        q => {
          ;(we(V, 'title', q),
            (K = Ie(U, 1, 'bar svelte-1ozbyr9', null, K, { active: n(R).tokens > 0 })),
            ot(U, `height:${(n(R).tokens / n(s)) * 100}%`))
        },
...
function zd(t, e) {
  ...
  function a(i) {
    ...
    let d = 100 - o.reduce((f, g) => f + g, 0)
    const h = v.map((f, g) => ({ i: g, frac: f - Math.floor(f) })).sort((f, g) => g.frac - f.frac),
      _ = o.slice()
    for (let f = 0; f < h.length && d > 0; f++) ((_[h[f].i] += 1), d--)
    return _
  }
  const s = Y(() => a(e.models))
  var l = Md()
  ;(Se(
    l,
    23,
    ...
    (i, v, o) => {
        ...
        y = c(m)
      {
        var w = z => {
            ...
            ;(Se(
              ...
              (S, T) => {
                ...
                ;(L(
                  F => {
                    ;((j = Ie(B, 1, 'app-badge svelte-1ca0tub', null, j, F)), A(O, T))
                  },
                  [() => ({ agy: T.toLowerCase() === 'antigravity' })]
                ),
                  p(S, B))
              }
            ),
        ...
        H(y, z => {
          var b
          ;(b = n(v).apps) != null && b.length ? z(w) : z($, -1)
        })
      }
      var N = u(_, 2),
        E = c(N),
      ...
      ;(L(
        (z, b) => {
          ;(ot(h, `background:${n(v).color ?? ''}`),
            we(f, 'title', `${n(v).provider ?? ''}: ${n(v).model ?? ''}`),
            A(g, `${n(v).provider ?? ''}: ${n(v).model ?? ''}`),
            A(R, `↓ ${z ?? ''}`),
            A(V, `↑ ${b ?? ''}`),
...
var Ad = k('<span class="offline svelte-1thed0a">Offline</span>'),
  ...
  Ld = k('<div class="section svelte-1thed0a"><!></div> <!>', 1),
  $d = k(
...
function Kd(t, e) {
  ;(he(e, !0), ue(e, 'showSampleBadge', 3, !0))
  let r = ee('overview')
  const a = Y(() => Ee.list.reduce((S, T) => S + T.enrichedModels.length, 0)),
    s = Y(() => Ee.list.length),
    l = Y(() => Ge.list.filter(S => S.installed))
  function i(S) {
    en(S)
  }
  Lt(() => {
  ...
  var E = u(N, 2)
  {
    var R = S => {
        var T = Cd(),
          B = c(T)
        ;(ir(B, { label: 'Loading analytics…' }), p(S, T))
      },
      D = S => {
        var T = Id(),
          B = u(c(T), 2),
          j = c(B)
        ;(L(() => A(j, be.error)), p(S, T))
      },
      V = S => {
        var T = rt(),
          B = Q(T)
        {
          ...
          H(B, F => {
            n(r) === 'overview' ? F(j) : F(O, -1)
          })
        }
        p(S, T)
      }
    H(E, S => {
      be.loading && !be.report ? S(R) : be.error ? S(D, 1) : be.report && S(V, 2)
    })
  }
  var M = u(E, 2),
    U = c(M)
  Ae(U, {
    ...
    children: (S, T) => {
        ...
        j = u(Q(B), 2)
      {
        ...
        H(j, W => {
          Ge.loading ? W(O) : n(l).length === 0 ? W(F, 1) : W(J, -1)
        })
      }
      p(S, B)
    },
  ...
  Ae(b, {
    ...
    children: (S, T) => {
      var B = Hd(),
        j = c(B),
        O = c(j)
      ;(L(() => A(O, fe.general.length + fe.agy.length)), p(S, B))
    },
    $$slots: { default: !0 },
  })
  var q = u(b, 2)
  ;(Ae(q, {
    ...
    children: (S, T) => {
        ...
        F = u(j, 3)
      {
        ...
        H(F, W => {
          var G
          ;(G = Ye.status) != null && G.running && W(J)
        })
      }
      ;(L(() => A(O, n(l).length)), p(S, B))
    },
    $$slots: { default: !0 },
  }),
    L(() =>
...
function Fs(t, e) {
  he(e, !0)
  let r = ue(e, 'size', 3, 34)
  const a = Y(() => Vd(e.id)),
    s = Y(() => e.id.slice(0, 1).toUpperCase())
  var l = Xd(),
    i = c(l)
  {
    var v = d => {
        var h = Yd()
        ;(ro(h, () => n(a).svg, !0),
          L(() => ot(h, `width:${r() * 0.55}px;height:${r() * 0.55}px`)),
          p(d, h))
      },
      o = d => {
        var h = Jd(),
          _ = c(h)
        ;(L(() => {
          ;(ot(h, `font-size:${r() * 0.42}px`), A(_, n(s)))
        }),
          p(d, h))
      }
    H(i, d => {
...
function nc(t, e) {
    ...
    g = c(f)
  {
    var m = b => {
        Ce(b, {
          ...
          children: (q, S) => {
            var T = X()
            ;(L(() => A(T, e.provider.freeAccess ? 'Free access' : 'Key set')), p(q, T))
          },
          $$slots: { default: !0 },
        })
      },
  ...
  Se(
    ...
    (b, q) => {
      var S = Zd(),
        T = c(S)
      ;(L(() => {
        ;(we(S, 'title', n(q).id), A(T, n(q).name ?? n(q).id))
      }),
        p(b, S))
    }
  )
  var E = u(N, 2)
  {
    var R = b => {
      var q = Qd(),
        S = c(q)
      ;(L(() => A(S, `+${e.provider.enrichedModels.length - 5}`)), p(b, q))
    }
    H(E, b => {
  ...
  var D = u(E, 2)
  {
    ...
    H(D, b => {
      e.provider.enrichedModels.length === 0 && b(V)
    })
  }
  var M = u($, 2),
    U = c(M)
    ...
    var K = b => {
      ...
      I = b => {
        ...
        var T = u(S, 2)
        {
          var B = j => {
            var O = tc()
            ;(L(() => we(O, 'href', e.provider.signupUrl)), p(j, O))
          }
          H(T, j => {
            e.provider.signupUrl && j(B)
          })
        }
        p(b, q)
      },
...
var lc = k('<p style="color:var(--text-3)">Loading templates…</p>'),
  ...
  vc = k('<span class="lbl svelte-263z8" style="margin-top:14px">API key</span> <!> <!>', 1),
  dc = k('<span class="lbl svelte-263z8" style="margin-top:14px"> </span> <!>', 1),
  cc = k(
    '<span class="lbl svelte-263z8" style="margin-top:14px">Display name</span> <!> <span class="lbl svelte-263z8" style="margin-top:14px">Base URL</span> <!> <span class="lbl svelte-263z8" style="margin-top:14px">API key <span style="color:var(--text-3)">(optional)</span></span> <!>',
    1
  ),
  uc = k(
...
function fc(t, e) {
  ...
  Lt(() => {
    e.open && (d(), C(s, null), C(l, ''), C(i, ''), C(v, ''))
  })
  const h = Y(() => n(r).find(m => m.id === n(s))),
    _ = Y(() => n(s) === '__custom_openai__'),
    f = Y(() => n(s) === '__custom_anthropic__')
  async function g() {
    if (n(s)) {
      C(o, !0)
      try {
        ...
        ;(n(_) || n(f)
          ...
          : (m = await Ao(n(s), n(l) || void 0, n(i) || void 0)),
          m.ok
            ? (ge(`Added ${m.name ?? n(s)}`, 'success'), e.onadded(), e.onclose())
            : ge(m.error ?? 'Failed to add provider', 'error'))
      } catch (m) {
        ge(m instanceof Error ? m.message : String(m), 'error')
      }
      C(o, !1)
    }
  }
          ...
          E = R => {
            ...
            Se(
              ...
              (j, O) => {
                ...
                ;(L(() => {
                  ;(A(
                    J,
                    `${n(O).name ?? ''}${n(O).anonymousFreeModels ? ' (free)' : ''}${n(O).subscriptionRisk ? ' ⚠' : ''}`
                  ),
                    W !== (W = n(O).id) && (F.value = (F.__value = n(O).id) ?? ''))
                }),
                  p(j, F))
              }
            )
            var K = u(V, 2)
            {
              var I = j => {
                var O = vc(),
                  F = u(Q(O), 2)
                {
                  let G = Y(() => (n(h).apiKeyOptional ? 'optional' : 'Paste your key'))
                  Zt(F, {
                    get placeholder() {
                      return n(G)
                    },
                ...
                var J = u(F, 2)
                {
                  var W = G => {
                    var Z = oc()
                    ;(L(() => we(Z, 'href', n(h).signupUrl)), p(G, Z))
                  }
                  H(J, G => {
                    n(h).signupUrl && G(W)
                  })
              ...
              H(K, j => {
                n(h) && n(h).authType === 'api' && !n(h).apiKeyOptional && !n(_) && !n(f) && j(I)
              })
            }
            var P = u(K, 2)
            {
              var z = j => {
                var O = dc(),
                  ...
                  W = u(F, 2)
                {
                  let G = Y(() => n(h).defaultBaseUrl ?? 'https://')
                  Zt(W, {
                    get placeholder() {
                      return n(G)
                    },
                ...
                ;(L(() => A(J, n(h).urlPrompt)), p(j, O))
              }
              H(P, j => {
                var O
                ;(O = n(h)) != null && O.urlPrompt && j(z)
              })
            }
            var b = u(P, 2)
            {
            ...
            var B = u(T, 2)
            {
              ...
              _e(B, {
                ...
                children: (O, F) => {
                  var J = X()
                  ;(L(() => A(J, n(o) ? 'Adding…' : 'Add provider')), p(O, J))
                },
                $$slots: { default: !0 },
              })
            }
    ...
    xr(t, {
      ...
      children: (a, s) => {
        ...
        ;(_e(f, {
          ...
          L(() => {
            var g, m
            ;(A(o, (g = e.provider) == null ? void 0 : g.name),
              A(
                d,
                ` and all ${((m = e.provider) == null ? void 0 : m.modelCount) ?? 0 ?? ''} of its models from anygate? This clears stored credentials.`
              ))
          }),
          p(a, l))
      },
...
var _c = k('<div class="grid svelte-1sgc4qo"></div>'),
  gc = k('<p class="code svelte-1sgc4qo">Enter code: <strong> </strong></p>'),
  mc = k(
...
function wc(t, e) {
  ...
  async function o(I) {
    try {
      const P = await Co(I.id)
      P.ok
        ? ge(`Deleted ${I.name}`, 'success')
        : ge(P.error ? String(P.error) : 'Delete failed', 'error')
    } catch (P) {
      ge(P instanceof Error ? P.message : String(P), 'error')
    }
    ;(C(a, null), await Sa())
  }
  async function d(I) {
    ...
    if (P)
      try {
        ;(await Po(I.id, P)).ok
          ? (ge('Key saved', 'success'), await fl(I.id))
          : ge('Save failed', 'error')
      } catch (z) {
        ge(z instanceof Error ? z.message : String(z), 'error')
      }
  }
  async function h(I) {
    C(s, I, !0)
    try {
      const P = await Io(I.id)
      ;(C(l, P.authUrl ?? P.url, !0),
        C(i, P.userCode ?? '', !0),
        P.sessionId &&
          C(
            v,
            setInterval(async () => {
              ...
              z.status !== 'pending' &&
                ...
                z.status === 'done'
                  ? (ge(`${I.name} connected`, 'success'), C(s, null), await Sa())
                  : ge(z.error ?? 'OAuth failed', 'error'))
            }, 2e3),
            !0
          ),
  ...
  var $ = u(g, 2)
  {
    var N = I => {
      ...
      R = I => {
        zr(I, {
          ...
          children: (P, z) => {
            var b = X('Add a provider to start browsing models.')
            p(P, b)
          },
          $$slots: { default: !0 },
        })
    ...
    H($, I => {
      Ee.loading ? I(N) : Ee.error ? I(E, 1) : Ee.list.length === 0 ? I(R, 2) : I(D, -1)
    })
  }
  var V = u(f, 2)
  fc(V, {
  ...
  var U = u(M, 2)
  {
    var K = I => {
      ...
      ;(_e(O, {
        ...
        L(() => A(q, `Sign in to ${n(s).name ?? ''}`)),
        ne('click', P, () => C(s, null)),
        ne('keydown', P, F => {
          F.key === 'Escape' && C(s, null)
        }),
        ne('click', z, F => F.stopPropagation()),
        ne('keydown', z, F => F.stopPropagation()),
        p(I, P))
    }
    H(U, I => {
      n(s) && I(K)
...
var Sc = k('<span class="group svelte-xohxs0"><!> <!> <!> <!> <!></span>')
function xl(t, e) {
  he(e, !0)
  var r = Sc(),
    a = c(r)
  ...
  var l = u(a, 2)
  {
    var i = g => {
      Ce(g, {
        ...
        children: (m, y) => {
          var w = X()
          ;(L(() => A(w, e.model.freeLabel)), p(m, w))
        },
        $$slots: { default: !0 },
      })
    }
    H(l, g => {
      e.model.freeLabel && !e.model.isFree && g(i)
    })
  }
  var v = u(l, 2)
  {
  ...
  var o = u(v, 2)
  {
    var d = g => {
      ...
      h = Y(() => {
        var g
        return (g = e.model.inputTypes) == null ? void 0 : g.includes('image')
      })
    H(o, g => {
      n(h) && g(d)
    })
  ...
  var _ = u(o, 2)
  {
    ...
    H(_, g => {
      e.model.reasoning && g(f)
    })
  }
  ;(p(t, r), pe())
}
var Pc = k('<button> </button>'),
  Ec = k(
...
function Mc(t, e) {
  he(e, !0)
  let r = ue(e, 'favorited', 3, !1)
  function a(N) {
    return N ? `${(N / 1e3).toFixed(0)}k` : '—'
  }
  function s(N) {
    ...
    var $ = N => {
      ...
      ;(L(() => {
        ;((R = Ie(E, 1, 'star svelte-19h4ccs', null, R, { on: r() })),
          we(E, 'title', r() ? 'Remove favorite' : 'Add favorite'),
          we(E, 'aria-label', r() ? 'Remove favorite' : 'Add favorite'),
          A(D, r() ? '★' : '☆'))
      }),
        ne('click', E, V => {
          ;(V.stopPropagation(), e.onToggleFav())
        }),
        p(N, E))
    }
    H(w, N => {
  ...
  ;(L(
    (N, E) => {
      ;((i = Ie(l, 1, 'row svelte-19h4ccs', null, i, { clickable: !!e.onOpen })),
        we(l, 'role', e.onOpen ? 'button' : void 0),
        we(l, 'tabindex', e.onOpen ? 0 : void 0),
    ...
    ne('click', l, () => {
      var N
      return (N = e.onOpen) == null ? void 0 : N.call(e)
    }),
    ne('keydown', l, N => {
      e.onOpen && (N.key === 'Enter' || N.key === ' ') && (N.preventDefault(), e.onOpen())
    }),
    p(t, l),
    pe())
}
Oe(['click', 'keydown'])
var zc = k('<option> </option>'),
  Ac = k(
...
function Tc(t, e) {
  ...
  function a(F, J) {
    var W
    ;(r({ ...r(), [F]: J }), (W = e.onchange) == null || W.call(e, r()))
  }
  var s = Ac(),
    l = c(s),
    i = u(l, 2),
  ...
  Se(
    ...
    (F, J) => {
      var W = zc(),
        ...
        Z = {}
      ;(L(() => {
        ;(A(G, n(J).name), Z !== (Z = n(J).id) && (W.value = (W.__value = n(J).id) ?? ''))
      }),
        p(F, W))
    }
  )
  ...
  var S = u(I, 2),
    T = c(S)
  T.value = T.__value = 'ctx'
  var B = u(T)
  B.value = B.__value = 'cost'
  var j = u(B)
  ...
  ;(Xt(S),
    L(() => {
      ;(Os(l, r().query),
        ...
        y !== (y = r().format) && ((h.value = (h.__value = r().format) ?? ''), Dt(h, r().format)),
        R !== (R = r().free) && ((w.value = (w.__value = r().free) ?? ''), Dt(w, r().free)),
        K !== (K = r().reasoning) &&
          ((D.value = (D.__value = r().reasoning) ?? ''), Dt(D, r().reasoning)),
        q !== (q = r().vision) && ((I.value = (I.__value = r().vision) ?? ''), Dt(I, r().vision)),
        O !== (O = r().sort) && ((S.value = (S.__value = r().sort) ?? ''), Dt(S, r().sort)))
    }),
    ne('input', l, F => a('query', F.currentTarget.value)),
    ne('change', i, F => a('provider', F.currentTarget.value)),
    ne('change', h, F => a('format', F.currentTarget.value)),
    ne('change', w, F => a('free', F.currentTarget.value)),
    ne('change', D, F => a('reasoning', F.currentTarget.value)),
    ne('change', I, F => a('vision', F.currentTarget.value)),
    ne('change', S, F => a('sort', F.currentTarget.value)),
    p(t, s),
    pe())
}
Oe(['input', 'change'])
          ...
          var de = u(Z, 2)
          {
            var ae = ie => {
              var ke = Cc(),
                se = u(c(ke)),
                ye = c(se)
              ;(L(() => A(ye, e.model.sourceBackend)), p(ie, ke))
            }
            H(de, ie => {
              e.model.sourceBackend && ie(ae)
            })
          }
          ;(L(
            (ie, ke, se) => {
              ;(A(f, e.model.name ?? e.model.id),
                ...
                A(B, e.model.reasoning ? 'Supported' : 'No'),
                A(F, ke),
                A(G, se))
            },
            [
...
function $c(t, e) {
  ...
  var i = u(l, 2),
    ...
    _ = u(i, 2)
  ;(L(() => {
    ;(A(s, e.index + 1), A(o, e.fav.model), A(h, e.fav.providerName))
  }),
    Ca('dragstart', r, function (...f) {
      var g
      ;(g = e.ondragstart) == null || g.apply(this, f)
    }),
    Ca('dragover', r, f => f.preventDefault()),
    Ca('drop', r, function (...f) {
      var g
      ;(g = e.ondrop) == null || g.apply(this, f)
    }),
    ne('click', _, function (...f) {
      var g
      ;(g = e.onremove) == null || g.apply(this, f)
    }),
    p(t, r),
    pe())
}
Oe(['click'])
var Rc = k('<div class="list svelte-156gwh2"><!> <div class="cap svelte-156gwh2"> </div></div>')
function Nc(t, e) {
  he(e, !0)
  let r = ee(null)
  function a(_, f) {
    var g
    ;(C(r, _, !0), (g = f.dataTransfer) == null || g.setData('text/plain', String(_)))
  }
  function s(_) {
    if (n(r) === null || n(r) === _) return
    const f = [...e.items],
      [g] = f.splice(n(r), 1)
    ;(f.splice(_, 0, g), C(r, null), e.onreorder(f))
  }
  var l = Rc(),
    i = c(l)
  {
    var v = _ => {
        zr(_, {
          ...
          children: (f, g) => {
            var m = X('Star models from the Models tab to build your quick-launch list.')
            p(f, m)
          },
          $$slots: { default: !0 },
        })
    ...
    H(i, _ => {
      e.items.length === 0 ? _(v) : _(o, -1)
    })
  }
  var d = u(i, 2),
    h = c(d)
  ;(L(() => A(h, `${e.items.length ?? ''} / ${e.max ?? ''} used`)), p(t, l), pe())
}
var Fc = k(
...
function Dc(t, e) {
  let r = ue(e, 'label', 3, '')
  const a = Y(() => Math.min(100, Math.round((e.used / e.max) * 100))),
    s = Y(() => e.used >= e.max)
  var l = Fc(),
    i = c(l),
    v = c(i),
  ...
  ;(L(() => {
    ;(A(o, r()),
      A(h, `${e.used ?? ''}/${e.max ?? ''}`),
      (g = Ie(f, 1, 'fill svelte-19jc277', null, g, { full: n(s) })),
      ot(f, `width:${n(a) ?? ''}%`))
  }),
    p(t, l))
}
...
function Bc(t, e) {
  he(e, !0)
  let r = ee(
      Ne({ provider: '', format: '', free: '', reasoning: '', vision: '', query: '', sort: 'ctx' })
    ),
    a = ee(null),
    s = ee('general')
  const l = Y(() =>
    Ee.list.flatMap(M =>
      M.enrichedModels.map(U => ({ model: U, providerId: M.id, providerName: M.name }))
    )
  )
  function i(M) {
  ...
  const v = Y(() =>
    n(l)
      ...
      .sort((M, U) =>
        n(r).sort === 'name'
          ? (M.model.name ?? M.model.id).localeCompare(U.model.name ?? U.model.id)
          : n(r).sort === 'cost'
            ? i(M.model.cost) - i(U.model.cost)
            : (U.model.contextWindow ?? 0) - (M.model.contextWindow ?? 0)
      )
  )
  function o(M, U) {
    return (n(s) === 'agy' ? fe.agy : fe.general).some(I => I.providerId === M && I.modelId === U)
  }
  async function d(M) {
    const U = M.model
    if (o(M.providerId, U.id)) await gs(M.providerId, U.id, n(s) === 'agy')
    else {
      const K = {
  ...
  async function h(M) {
    ;(n(s) === 'agy' ? (fe.agy = M) : (fe.general = M),
      await kc(() => Promise.resolve().then(() => av), void 0).then(U =>
        U.reorder(M, n(s) === 'agy')
      ))
  }
  var _ = qc(),
    ...
    y = c(m)
  {
    let M = Y(() => Ee.list.map(U => ({ id: U.id, name: U.name })))
    Tc(y, {
      get providers() {
        return n(M)
      },
  ...
  var w = u(y, 2)
  {
    var $ = M => {
      ...
      N = M => {
        zr(M, {
          ...
          children: (U, K) => {
            var I = X('Adjust filters or connect more providers.')
            p(U, I)
          },
          $$slots: { default: !0 },
        })
        ...
        Ae(M, {
          ...
          children: (U, K) => {
            ...
            ;(Se(
              ...
              (z, b) => {
                {
                  let q = Y(() => o(n(b).providerId, n(b).model.id))
                  Mc(z, {
                    get model() {
                      return n(b).model
                    },
    ...
    H(w, M => {
      Ee.loading ? M($) : n(v).length === 0 ? M(N, 1) : M(E, -1)
    })
  }
  var R = u(m, 2),
    D = c(R)
  Ae(D, {
    ...
    children: (M, U) => {
      var K = jc(),
        ...
        P = u(c(I), 2)
      {
        let S = Y(() => (n(s) === 'agy' ? fe.agy.length : fe.general.length)),
          T = Y(() => (n(s) === 'agy' ? 6 : 20)),
          B = Y(() => (n(s) === 'agy' ? 'AGY' : 'General'))
        Dc(P, {
          get used() {
            return n(S)
          },
      ...
      var b = u(z, 2),
        q = c(b)
      {
        let S = Y(() => (n(s) === 'agy' ? fe.agy : fe.general)),
          T = Y(() => (n(s) === 'agy' ? 6 : 20))
        Nc(q, {
          get items() {
            return n(S)
          ...
          onreorder: h,
          onremove: B => gs(B.providerId, B.modelId, n(s) === 'agy'),
        })
      }
      p(M, K)
    },
...
function Yc(t, e) {
  ...
  var w = u(s, 2)
  {
    var $ = K => {
      var I = Hc(),
        P = c(I)
      ;(L(() => {
        ;(we(I, 'title', e.app.path), A(P, e.app.path))
      }),
        p(K, I))
    }
    H(w, K => {
  ...
  var N = u(w, 2)
  {
    var E = K => {
      var I = Uc(),
        P = u(c(I), 2),
        z = c(P)
      ;(L(() => A(z, `${r() ?? ''} favorite${r() === 1 ? '' : 's'} ready`)), p(K, I))
    }
    H(N, K => {
      r() > 0 && K(E)
    })
        ...
        P = c(I)
      {
        var z = q => {
            var S = Gc(),
              T = c(S)
            ;(L(() => {
              ;(we(S, 'href', e.app.installUrl), A(T, `Get ${e.app.name ?? ''} →`))
            }),
              p(q, S))
          },
          b = q => {
            var S = Kc(),
              ...
              B = c(T),
              j = u(T, 2)
            ;(L(() => A(B, e.app.installHint)),
              ne('click', j, () => {
                var O
                return (O = navigator.clipboard) == null
                  ? void 0
                  : O.writeText(e.app.installHint ?? '')
              }),
              p(q, S))
          }
        H(P, q => {
          e.app.installUrl ? q(z) : e.app.installHint && q(b, 1)
        })
      }
      p(K, I)
    }
  ...
  var U = u(M, 2)
  {
    ...
    _e(U, {
      ...
      children: (I, P) => {
        var z = X()
        ;(L(() => A(z, r() > 0 ? 'Launch with favorites' : 'Launch')), p(I, z))
      },
      $$slots: { default: !0 },
    })
  }
...
Oe(['click'])
var Jc = k('<div class="grid svelte-ishglm"></div>'),
  Xc = k(
  ...
  Qc = k('<button class="recent svelte-ishglm"> </button>'),
  eu = k('<div class="recents svelte-ishglm"></div>'),
  tu = k(
...
function su(t, e) {
  ...
  let r = ee(null),
    ...
    v = ee(null),
    o = ee('')
  const d = Y(() => Ge.list.find(z => z.id === n(r))),
    h = Y(() =>
  ...
  async function f(z) {
    ;(C(r, z.id, !0), C(a, n(h) > 0 ? 'favorites' : 'specific', !0), C(s, ''), C(l, ''), C(i, ''))
  ...
  async function m(z) {
    ;(C(v, z, !0), C(o, z.path ?? '', !0))
  }
  async function y() {
    n(v) && (await nv(n(v).id, n(o).trim() || null), C(v, null))
  }
  async function w() {
    const z = await Qs()
    z && C(i, z, !0)
    ...
    R = u(c(E), 2)
  {
    var D = z => {
      ...
      V = z => {
        zr(z, {
          ...
          icon: 'M2 3h20v14H2z',
          children: (b, q) => {
            var S = X("anygate couldn't detect supported apps on this system.")
            p(b, S)
          },
          $$slots: { default: !0 },
        })
    ...
    H(R, z => {
      Ge.loading ? z(D) : Ge.list.length === 0 ? z(V, 1) : z(M, -1)
    })
  }
  var U = u(E, 2)
  {
        ...
        xr(z, {
          ...
          children: (S, T) => {
            ...
            var ie = u(j, 2)
            {
              ...
              H(ie, Pe => {
                n(a) === 'specific' ? Pe(ke) : n(a) === 'favorites' && Pe(se, 1)
              })
            }
            var ye = u(ie, 2),
              je = u(c(ye), 2),
              ...
              var Yt = Pe => {
                  ...
                  ;(Se(
                    ...
                    (Ke, He) => {
                      var Xe = Qc(),
                        Ue = c(Xe)
                      ;(L(() => A(Ue, n(He))), ne('click', Xe, () => C(i, n(He), !0)), p(Ke, Xe))
                    }
                  ),
                    p(Pe, Fe))
                },
                vt = Y(() => Ge.recentFolders.filter(Pe => Pe !== n(i)).length)
              H(Vt, Pe => {
                n(vt) && Pe(Yt)
              })
            }
            ...
            var zt = u(Ft, 2)
            {
              let Pe = Y(() => !n(d).installed || (n(a) === 'specific' && !!n(s) && !n(l)))
              _e(zt, {
                get disabled() {
                  return n(Pe)
                },
            ...
            ;(L(() => {
              ;((F = Ie(O, 1, 'mode svelte-ishglm', null, F, { active: n(a) === 'favorites' })),
                (O.disabled = n(h) === 0),
                A(G, n(h) > 0 ? `${n(h)} models into the app switcher` : 'No favorites saved yet'),
                (re = Ie(Z, 1, 'mode svelte-ishglm', null, re, { active: n(a) === 'specific' })),
                (ae = Ie(de, 1, 'mode svelte-ishglm', null, ae, { active: n(a) === 'open' })))
            }),
              ne('click', O, () => C(a, 'favorites')),
              ne('click', Z, () => C(a, 'specific')),
              ne('click', de, () => C(a, 'open')),
              p(S, B))
          },
          $$slots: { default: !0 },
        })
    ...
    a = Q(r)
  {
    var s = i => {
        ...
        Ce(o, {
          ...
          children: (_, f) => {
            var g = X()
            ;(L(() => A(g, `Running · ${e.status.listenMode === 'network' ? 'Network' : 'Local'}`)),
              p(_, g))
          },
          $$slots: { default: !0 },
        })
        var d = u(o, 2)
        {
          var h = _ => {
            Ce(_, {
              ...
              children: (f, g) => {
                var m = X()
                ;(L(() => A(m, `${e.status.models.length ?? ''} models`)), p(f, m))
              },
              $$slots: { default: !0 },
            })
          }
...
var iu = k(
  ...
  vu = k('<div class="summary svelte-swldy1"> </div>'),
  du = k(
  ...
  uu = k('<div class="opts svelte-swldy1"><!> <!> <!> <!> <!></div>'),
  fu = k(
...
function hu(t, e) {
  ...
  function d() {
    n(o) &&
      (C(r, n(o).saved.favoritesOnly, !0),
      C(a, n(o).saved.freeModelsOnly, !0),
      C(s, n(o).saved.maskGatewayIds, !0),
      C(l, n(o).saved.listenMode, !0))
  }
  Lt(() => {
    n(o) && d()
  })
  async function h() {
    ...
    ;(n(l) === 'network' && !n(i).trim() && C(i, Math.random().toString(36).slice(2, 12), !0),
      !(await Gv({
        favoritesOnly: n(r),
        freeModelsOnly: n(a),
        ...
        ((V = e.onneedsmodels) == null || V.call(e)))
  }
  var _ = fu(),
    f = c(_),
    g = u(c(f), 2)
  ...
  var m = u(f, 2)
  {
          ...
          z = u(K, 2)
        {
          var b = T => {
            ...
            Se(
              ...
              (W, G) => {
                var Z = iu(),
                  ...
                  ie = c(ae)
                ;(L(() => {
                  ;(A(de, n(G).name), A(ie, n(G).anthropicUrl))
                }),
                  p(W, Z))
              }
            )
            var O = u(j, 2),
              F = u(c(O)),
              J = c(F)
            ;(L(() => A(J, n(o).apiKey)), p(T, B))
          }
          H(z, T => {
            n(o).listenMode === 'network' && n(o).networkUrls && T(b)
          })
        }
        var q = u(D, 2)
        {
          var S = T => {
            var B = vu(),
              j = c(B)
            ;(L(() => A(j, n(o).providerSummary)), p(T, B))
          }
          H(q, T => {
            n(o).providerSummary && T(S)
          })
        }
        ;(L(() => {
          ;(A(U, n(o).anthropicUrl), A(P, n(o).openaiUrl))
        }),
          p(E, R))
      },
      w = E => {
        ...
        var U = u(M, 2)
        {
          ...
          ea(U, {
            ...
            onchange: z => C(l, z ? 'network' : 'local', !0),
            label: 'Network mode',
          })
        }
        var K = u(U, 2)
    ...
    H(m, E => {
      var R
      ;(R = n(o)) != null && R.running ? E(y) : E(w, -1)
    })
  }
  var $ = u(m, 2),
    N = c($)
...
var pu = k('<p style="color:var(--error);font-size:13px"> </p>'),
  _u = k(
...
function gu(t, e) {
    ...
    a = u(c(r), 2)
  {
    var s = o => {
      ...
      l = o => {
        hu(o, { onneedsmodels: () => (location.hash = '#/providers') })
      }
    H(a, o => {
...
var mu = k('<div class="muted svelte-hss3zz">Loading providers…</div>'),
  yu = k('<div class="muted svelte-hss3zz">No providers configured.</div>'),
  wu = k('<div class="muted svelte-hss3zz">Select a provider first.</div>'),
  bu = k(
  ...
  Mu = k('<p class="fail-hint svelte-hss3zz"> </p>'),
  zu = k(
...
function Ou(t, e) {
  ...
  const o = Y(() =>
      Ee.list
        .filter(b => {
          var q
          return (((q = b.enrichedModels) == null ? void 0 : q.length) ?? 0) > 0
        })
        .map(b => ({ value: b.id, label: b.name }))
    ),
    d = Y(() => Ee.list.find(b => b.id === n(r)))
  function h(b) {
    return b.format === 'anthropic' || b.format === 'openai'
  }
  const _ = Y(() => {
      var b
      return (((b = n(d)) == null ? void 0 : b.enrichedModels) ?? []).filter(h)
    }),
    f = Y(() =>
      n(_).map(b => ({
        value: b.id,
  ...
  Lt(() => {
    ;(n(r) && n(d) && n(_).some(q => q.id === n(a))) || C(a, '')
  })
  const g = Y(() => !!n(r) && !!n(a) && !n(l))
  async function m() {
    if (n(g)) {
      ;(C(l, !0), C(i, null), C(v, null))
      try {
        const b = await So({ providerId: n(r), modelId: n(a), prompt: n(s) })
        ;(C(i, b, !0),
          b.ok
            ? ge(`Test passed · ${b.ttftMs}ms TTFT`, 'success')
            : ge(b.error ?? 'Test failed', 'error'))
      } catch (b) {
        ;(C(v, b instanceof Error ? b.message : String(b), !0), ge('Network error', 'error'))
      } finally {
        C(l, !1)
      }
    }
  ...
  Ae(D, {
    ...
    children: (b, q) => {
        ...
        B = u(c(T), 2)
      {
        ...
        H(B, se => {
          Ee.loading ? se(j) : n(o).length === 0 ? se(O, 1) : se(F, -1)
        })
      }
      var J = u(T, 2),
        W = u(c(J), 2)
      {
        ...
        H(W, se => {
          n(r) ? (n(f).length === 0 ? se(Z, 1) : se(re, -1)) : se(G)
        })
      }
      var de = u(J, 2),
        ae = u(c(de), 2),
      ...
      K = b => {
        Ae(b, {
          ...
          children: (q, S) => {
            ...
            ;(L(
              (He, Xe) => {
                ;(ot(W, `stroke-dashoffset: ${329.9 - (329.9 * n(w)) / 100}`),
                  A(re, n(i).ttftMs ?? '—'),
                  A(ie, He),
                  A(ye, Xe),
        ...
        Ae(b, {
          ...
          children: (q, S) => {
            ...
            var J = u(O, 2)
            {
              ...
              H(J, G => {
                n(i).connectMs !== null && G(W)
              })
            }
            ;(L(() => A(j, n(i).error)), p(q, T))
          },
          $$slots: { default: !0 },
        })
      },
...
var Lu = k(
  ...
  Bu = k('<span class="lbl svelte-15j4tnx" style="margin-top:12px">Model</span> <!>', 1),
  Hu = k(
...
function Gu(t, e) {
  ...
  function v() {
    Ho()
      ...
      .catch(S => ge(String(S), 'error'))
  }
  async function o() {
    try {
      ;(await Uo(n(l)), ge('Config imported', 'success'), C(s, !1), await gl())
    } catch (S) {
      ge(S instanceof Error ? S.message : String(S), 'error')
    }
  }
  function d() {
    const S = new Blob([n(a)], { type: 'application/json' }),
      T = document.createElement('a')
    ;((T.href = URL.createObjectURL(S)), (T.download = 'anygate-config.json'), T.click())
  }
  let h = ee(!1),
    _ = ee(''),
    f = ee(''),
    ...
    m = ee('')
  function y(S) {
    const T = Ee.list.find(O => O.id === S.providerId),
      B = T == null ? void 0 : T.enrichedModels.find(O => O.id === S.modelId)
    return !T || !B
      ? '—'
      : Go({ provider: T, modelId: B.id, contextWindow: B.contextWindow }).env.map(
          O => `${O.key}=${O.masked ? '•••' : O.value}`
        ).join(`
`)
  }
  var w = Uu(),
  ...
  Ae(R, {
    ...
    children: (S, T) => {
      ...
      ;(_e(O, {
        ...
        children: (F, J) => {
          var W = X()
          ;(L(() => A(W, `${ar.value === 'dark' ? 'Dark' : 'Light'} · toggle`)), p(F, W))
        },
        $$slots: { default: !0 },
      }),
        p(S, B))
      ...
      var F = u(j, 2)
      {
        var J = G => {
            zr(G, {
              ...
              icon: 'M12 5v14M5 12h14',
              children: (Z, re) => {
                var de = X('Save an app + provider + model combo for one-click launch.')
                p(Z, de)
              },
              $$slots: { default: !0 },
            })
                ...
                ke = u(Q(ie), 2)
              {
                let se = Y(() => {
                  ...
                  return [
                    { value: '', label: '—' },
                    ...(
                      ((ye = Ee.list.find(je => je.id === n(f))) == null
                        ? void 0
                        : ye.enrichedModels) ?? []
                    ).map(je => ({ value: je.id, label: je.name ?? je.id })),
                  ]
                })
                sr(ke, {
                  get options() {
...
try {
  Ji(Wu, { target: document.getElementById('app') })
} catch (t) {
