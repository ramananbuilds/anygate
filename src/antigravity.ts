...
import { detectConflicts, buildAntigravityChildEnv } from './core/env.js';
...
import type { FavoriteModel, UserPreferences, LocalProvider, LocalProviderModel } from './core/types.js';
