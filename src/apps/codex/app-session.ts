...
export function getAppCatalogPath(
  providerId: string,
...
export function readAppSessionLock(
  env: NodeJS.ProcessEnv = process.env
): CodexAppSessionLock | null {
...
export function writeAppSessionLock(
  lock: CodexAppSessionLock,
  env: NodeJS.ProcessEnv = process.env
): void {
...
export function readAppRestoreState(
  env: NodeJS.ProcessEnv = process.env
): CodexAppRestoreState | null {
...
export function writeAppRestoreState(
...
export function saveAppRestoreStateBeforePatch(
  env: NodeJS.ProcessEnv = process.env
): CodexAppRestoreState {
...
export function restoreCodexAppOverlay(
  env: NodeJS.ProcessEnv = process.env
): RestoreAppOverlayResult {
...
export function recoverInterruptedCodexAppSession(
  env: NodeJS.ProcessEnv = process.env
): AppInterruptedRecovery {
  const lock = readAppSessionLock(env)
...
export function checkAppSessionLock(
  isTty: boolean,
  env: NodeJS.ProcessEnv = process.env
): AppSessionCheckResult {
