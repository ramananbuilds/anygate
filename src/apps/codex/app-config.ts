...
function mergeAppConfig(existing: TomlRecord, spec: CodexAppConfigSpec): TomlRecord {
  ...
  const existingEffort =
    typeof out.model_reasoning_effort === 'string' ? out.model_reasoning_effort : undefined
...
export function applyAppConfigPatch(
...
export function restoreConfigFromState(
