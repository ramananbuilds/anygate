...
// Pure list-level operations on the favorite model list.
// Shared across CLI surfaces (claude, codex, gemini, models command)
// to eliminate the previous duplication in src/apps/claude/favorites.ts.
...
export type AddFavoriteResult =
  { ok: true; list: FavoriteModel[] } | { ok: false; reason: 'duplicate' | 'cap' }
