...
function decodeAuthEntry(value: unknown): OpencodeAuthEntry | null {
  ...
  if (
    ...
    return {
      ...
      enterpriseUrl:
        typeof record['enterpriseUrl'] === 'string' ? record['enterpriseUrl'] : undefined,
    }
  }
  if (
    record['type'] === 'wellknown' &&
...
export function isOpencodeOAuth(
  entry: OpencodeAuthEntry | undefined
): entry is OpencodeOAuthCredential {
